...
public class chatServer implements ActionListener {
    ...
    chatServer() {
        ...
        more.setBounds(340, 20, 20, 30);
        panel.add(more);

        JLabel name = new JLabel("Shailedra");
        ...
        a1 = new JPanel();
        a1.setBounds(5, 75, 390, 570);
        f.add(a1);

        text = new JTextField();
        text.setBounds(5, 655, 280, 40);
        text.setFont(new Font("SAN_SERIF", Font.PLAIN, 16));
        f.add(text);

        JButton send = new JButton("Send");
        send.setBounds(290, 655, 110, 40);
    ...
    public static void main(String[] args) {
        new chatServer(); // anonymous object
